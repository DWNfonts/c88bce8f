...
import com.dwnfonts.c88bce8f.VectorFontExporter;
...
public class Main {
	public static void main(String[] args) {
		...
		if (CommonMenuItems.IS_MAC_OS) {
			try { Class.forName("com.dwnfonts.c88bce8f.edit.mac.MacDummyWindow").newInstance(); }
		...
		if (CommonMenuItems.IS_MAC_OS) {
			try { Class.forName("com.dwnfonts.c88bce8f.edit.mac.MyApplicationListener").newInstance(); }
			catch (Exception e) { e.printStackTrace(); }
		}
	}
