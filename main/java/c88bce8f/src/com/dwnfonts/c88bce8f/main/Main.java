...
import com.dwnfonts.c88bce8f.puaa.PuaaCompiler;
import com.dwnfonts.c88bce8f.puaa.PuaaDecompiler;
import com.dwnfonts.c88bce8f.puaa.PuaaLookup;

public class Main {
	public static void main(String[] args) {
		if (args.length == 0) {
			com.dwnfonts.c88bce8f.edit.Main.main(args);
		} else {
